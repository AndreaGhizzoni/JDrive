 ...
 *
 */
public final class GoogleAuthenticatorV2 {

    private static GoogleAuthenticatorV2 instance;
    private static final Logger log = LogManager.getLogger(
            GoogleAuthenticatorV2.class.getSimpleName()
    );
     ...
     * @return
     */
    public static GoogleAuthenticatorV2 getInstance() throws GeneralSecurityException,
            IOException {
        if( instance == null )
            instance = new GoogleAuthenticatorV2();
        return instance;
    }
...
//==============================================================================
    ...
    private void buildGoogleAuthCodeFlow() throws IOException {
        // Load client secrets.
        InputStream in = GoogleAuthenticatorV2.class.getResourceAsStream(
                "/credentials.json");
